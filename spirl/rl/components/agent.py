...
class HierarchicalAgent(BaseAgent):
    ...
    def __init__(self, config):
        ...
        self.hl_agent = self._hp.hl_agent(self._hp.hl_agent_params.overwrite(self._hp))
        self.ll_agent = self._hp.ll_agent(self._hp.ll_agent_params.overwrite(self._hp))
